...
class _$FavoritesModelImpl implements _FavoritesModel {
  _$FavoritesModelImpl({required final List<Recipe> recipes})
      : _recipes = recipes;
  ...
  @override
  String toString() {
    return 'FavoritesModel(recipes: $recipes)';
  }
...
abstract class _FavoritesModel implements FavoritesModel {
  factory _FavoritesModel({required final List<Recipe> recipes}) =
